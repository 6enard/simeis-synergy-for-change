...
const Leadership = () => {
  ...
  const leaders = [
    ...
    },
    {
      ...
      position: "Vice Chair",
      image: "/dave2.jpg",
      shortStatement: "It has been my privilege as the Vice Chairman of SSC, the harbiger of hope and benevolence, to stand in reverence of the remarkable path that we've undertaken...",
      fullStatement: "It has been my privilege as the Vice Chairman of SSC, the harbiger of hope and benevolence, to stand in reverence of the remarkable path that we've undertaken through the visionary leadership of our Chairman and Founder. His steadfast direction has kindled in us a spark that has turned lives around and improved communities in waves of compassion and charity. It has been my privilege to attend every SSC function, and through that, I've seen the numerous touches of our shared mission, reaching in excess of 150 homes and putting smiles on the face of in excess of 1,000 children. It all began on January 27, 2024, at Mukuru Promotion Center, where the seeds of transformation got planted. On February 24, the CBD streets came to life with our outreach, and on March 23, we paid a special visit to Anita Home in North Kajiado in a display of love. During April 2024, we stood as pillars of support amidst families destroyed by floods, and on June 29, we hugged Serah's Vision Children's Home children. Throughout July and August, we fed Tana River families, and on November 23, we warmed the hearts of Flomina Children's Home. On February 22, 2025, our partnership with the FOS Friends of Society at the Getathuru Reception Centre amplified the reach of our efforts. On May 31, 2025, we made another visit to Mukuru Promotion Center, completing the full circle of our maiden outreach. One of the days that stand out the most is July 29, 2024, where we enabled a girl to pass the monetary Barrier by performing exceptionally in the final exam, thus graduating—triumph of perseverance and hope. These milestones, impacting over 100 families, are a testament to the boundless spirit of SSC. I, as the Vice Chairman, am privileged to be working alongside our inspiring Chairlady and the remarkable SSC community. Together, through the visionary leadership of our Founder, we are not only changing lives—we are igniting dreams and making the world a better place. Be a part of the movement that keeps spreading hope, one heart at a time"
    },
    {
      id: 3,
      name: "Darlene Kiptoo",
