    ...
    <section id="about" className="py-20 bg-cream">
      <div className="container mx-auto px-4 sm:px-6">
        ...
        <div className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 lg:gap-10 mb-16 sm:mb-20">
          {/* Mission */}
          <div className="bg-white rounded-3xl p-6 sm:p-8 lg:p-10 shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border border-gray-100 md:col-span-2 lg:col-span-1 animate-fade-in-up animate-delay-200">
            ...
            <h3 className="text-2xl sm:text-3xl font-heading text-gray-800 mb-4 sm:mb-6 text-center animate-typewriter">Our Mission</h3>
          ...
          {/* Vision */}
          <div className="bg-white rounded-3xl p-6 sm:p-8 lg:p-10 shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border border-gray-100 md:col-span-2 lg:col-span-1 animate-fade-in-up animate-delay-500">
            ...
            <h3 className="text-2xl sm:text-3xl font-heading text-gray-800 mb-4 sm:mb-6 text-center animate-typewriter animate-delay-300">Our Vision</h3>
            <p className="font-body text-gray-600 text-center leading-relaxed font-light text-sm sm:text-base">
          ...
          {/* Values */}
          <div className="bg-white rounded-3xl p-6 sm:p-8 lg:p-10 shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border border-gray-100 md:col-span-2 lg:col-span-1 animate-fade-in-up animate-delay-700">
            ...
            <h3 className="text-2xl sm:text-3xl font-heading text-gray-800 mb-4 sm:mb-6 text-center animate-typewriter animate-delay-500">Our Values</h3>
            <div className="space-y-4 sm:space-y-6">
              <div className="flex items-start space-x-3 animate-slide-in-left animate-delay-700">
              ...
              <div className="flex items-start space-x-3 animate-slide-in-left animate-delay-1000">
        ...
        <div className="bg-gradient-to-r from-lime via-orange to-lime rounded-3xl p-8 sm:p-12 md:p-16 text-white text-center shadow-2xl border border-white/20 animate-fade-in-up animate-delay-1000">
          <h3 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-heading mb-6 sm:mb-8 tracking-tight animate-pulse-slow">Creating Lasting Impact</h3>
