      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          ...
          <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
            ...
            <h3 className="text-2xl font-heading text-gray-800 mb-4 text-center">Our Mission</h3>
          ...
          <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
            ...
            <h3 className="text-2xl font-heading text-gray-800 mb-4 text-center">Our Vision</h3>
            <p className="font-body text-gray-600 text-center leading-relaxed">
          ...
          <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
            ...
            <h3 className="text-2xl font-heading text-gray-800 mb-4 text-center">Our Values</h3>
            <div className="space-y-4">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm font-body text-gray-600">Nurturing an inclusive empathetic environment where everyone feels valued</p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm font-body text-gray-600">Working together for amplified impact, fostering brighter futures</p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm font-body text-gray-600">Ensuring lasting impact through sustained support for community well-being</p>
                </div>
              </div>
            </div>
          </div>
        ...
        {/* Impact Statement */}
        <div className="bg-gradient-to-r from-lime to-orange rounded-2xl p-8 md:p-12 text-white text-center">
          <h3 className="text-3xl md:text-4xl font-heading mb-6">Creating Lasting Impact</h3>
          <p className="text-lg md:text-xl font-body max-w-4xl mx-auto leading-relaxed">
