...
const HomePage = () => {
  ...
  const leaders = [
    ...
    },
    {
      ...
      position: "Vice Chair",
      image: "/darlene.jpg",
      quote: "At Simei's Synergy for Change, being Vice Chair is not about titles, it's about service..."
    },
    {
      name: "Briton Waweru",
